...
public class TFMBuffaloModel<T extends TFMBuffalo> extends AgeableListModel<T> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 45).addBox(-4.5F, -7.0F, -7.0F, 9.0F, 7.0F, 9.0F, true), PartPose.offsetAndRotation(0.0F, 6.0F, -7.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -10.0F, -9.0F, 12.0F, 10.0F, 13.0F, true), PartPose.offsetAndRotation(0.0F, 7.0F, 2.0F, 1.4835298F, 0.0F, 0.0F));
        ...
        PartDefinition tail = root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(28, 53).addBox(-1.0F, 0.0F, -9.5F, 2.0F, 1.0F, 8.0F, true), PartPose.offsetAndRotation(0.0F, 7.0F, 11.5F, ((float)Math.PI / 2F), 0.0F, 0.0F));
        ...
        PartDefinition leg1 = root.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(46, 18).addBox(-1.0F, 0.0F, -3.0F, 4.0F, 11.0F, 5.0F, false), PartPose.offsetAndRotation(4.0F, 10.0F, -5.0F, 0.13962634F, 0.0F, 0.0F));
        ...
        PartDefinition leg2 = root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(46, 18).addBox(-3.0F, 0.0F, -3.0F, 4.0F, 11.0F, 5.0F, true), PartPose.offsetAndRotation(-4.0F, 10.0F, -5.0F, 0.13962634F, 0.0F, 0.0F));
